...
const getAnalysisCorrelationCalcStub = (request, response) => {
    let result = {
        "isSuccess": true, "message": "", "data": {
            ...
            "b": 378.4168862845811,
            "function": "-7.2569637815897705x + 378.4168862845811",
            "rxy": -0.10491021360182251,
            "vivodRXY": "Линейная корреляционная зависимость Y от X слабая",
            "koefDet": "0.011006153",
    ...
    if (start_date === undefined) {
        ...
        pool.query(query, (error, results) => {
            ...
            if (rxyABS > 0 && rxyABS <= 0.1) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X практически отсутствует';
            } else if (rxyABS > 0.1 && rxyABS <= 0.3) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X слабая';
            } else if (rxyABS > 0.3 && rxyABS <= 0.5) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X умеренная';
            } else if (rxyABS > 0.5 && rxyABS <= 0.7) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X заметная';
            } else if (rxyABS > 0.7 && rxyABS <= 0.9) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X сильная';
            } else if (rxyABS > 0.0 && rxyABS <= 0.99) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X очень сильная';
            } else if (rxyABS > 0.99) {
                vivodRXY = 'Линейная корреляционная зависимость Y от X практически фунциональная';
            }
